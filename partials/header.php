...
<?php foreach ($navItems as $item): ?>
      <a href="<?= htmlspecialchars($navLink($item), ENT_QUOTES, 'UTF-8'); ?>" class="<?= htmlspecialchars($navClasses($item['id'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>"><?= htmlspecialchars($item['label'] ?? '', ENT_QUOTES, 'UTF-8'); ?></a>
<?php endforeach; ?>
    </nav>
